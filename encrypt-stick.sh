...
[ -n "$GOCRYPTFS" ] || { echo "ERROR: gocryptfs not found. Get it: https://github.com/rfjakob/gocryptfs/releases"; exit 1; }
...
"$(command -v fusermount3 || command -v fusermount)" -u "$MOUNT"
echo ""
